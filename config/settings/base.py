"""
Base settings for pulsemanager project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'pulsemanager.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'pulsemanager.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'pulsemanager.users.adapters.SocialAccountAdapter'
